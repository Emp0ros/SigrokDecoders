...
# Test decoder
clear; sigrok-cli -i i2c_trace.sr -P "i2c:sda=SB SDA:scl=SB SCL,max6958,xbox_one_sb_post" -P "i2c:sda=SOC SDA:scl=SOC SCL,xbox_one_soc_post" -A "xbox_one_soc_post,xbox_one_sb_post"
